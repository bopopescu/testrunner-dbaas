...
class BaseTestCase(unittest.TestCase):
    def setUp(self):
        ...
        if not self.skip_host_login:
            shell = RemoteMachineShellConnection(self.main,exit_on_failure=False)
    ...
    def _bucket_creation(self):
        if self.default_bucket:
            default_params = self._create_bucket_params(
                server=self.main, size=self.bucket_size,
    ...
    def _create_scope_collection(self):
        ...
        for spec in list(self.main.collections_map.items()):
            ...
            for bucket in self.buckets:
                ...
                if map_bucket_name == bucket.name:
                    ...
                    collection_tasks.append(
                        self.cluster.create_scope_collection(self.main, map_bucket_name, scope_name, collection_name,
                                                             collection_params))
