...
class QueriesIndexTestsExtended(QueryTests):
    ...
    def test_meta_indexcountscan(self):
        ...
        for bucket, query_bucket in zip(self.buckets, self.query_buckets):
            ...
            query_1 = 'explain select count(1) from {0} where name = employee-23 and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_2 = 'select count(1) from {0} where name = "employee-23" and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_3 = 'explain select name from {0} where name = "employee-23" and meta().id like "query-testemployee%" limit 3'.format(query_bucket)
            ...
            query_4 = 'select name from {0} where name = "employee-23" and meta().id like "query-testemployee%" limit 3'.format(query_bucket)
            ...
            query_5 = 'explain select min(join_day) from {0} where VMs[0].memory=12 and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_6 = 'select min(VMs[0].memory) from {0} where join_mo=12 and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_7 = 'select min(join_mo) from {0} where  VMs[0].memory=12 and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_8 = 'explain select count(1) from {0} where name = "employee-23"'.format(query_bucket)
            ...
            query_9 = 'select count(1) from {0} where name = "employee-23"'.format(query_bucket)
            ...
            query_10 = 'explain select count(1) from {0} where name = "employee-23" and join_yr=2010'.format(query_bucket)
            ...
            query_11 = 'select count(1) from {0} where name = "employee-23" and join_mo=12'.format(query_bucket)
            ...
            query_12 = 'explain select count(1) from {0} where name = "employee-23" and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_13 = 'select count(1) from {0} where name = "employee-23" and meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_14 = 'explain select count(1) from {0} where meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_15 = 'select count(1) from {0} where meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_16 = 'explain select count(1) from {0} where meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_17 = 'select count(1) from {0} where meta().id = "query-testemployee10317.900449741801-0"'.format(query_bucket)
            ...
            query_18 = 'explain select count(*) from {0} where join_yr>2010 and join_mo = 12'.format(query_bucket)
            ...
            query_19 = 'select count(*) from {0} where join_yr>2010 and join_mo = 12'.format(query_bucket)
            ...
            query_20 = 'explain select count(*) from {0} where join_day = 23 and join_yr<2010'.format(query_bucket)
            ...
            query_21 = 'select count(*) from {0} where join_day = 23 and join_yr<2011'.format(query_bucket)
            ...
            query_22 = 'explain select count(*) from {0} where join_day = 23 and join_yr<2012 limit 10'.format(query_bucket)
            ...
            query_23 = 'explain select count(1) from {0} where name = "employee-23" and join_day = 23'.format(query_bucket)
            ...
            query_24 = 'explain select count(1) from {0} where name = "employee-23" and join_yr = 2010'.format(query_bucket)
            ...
            query_25 = 'explain select tasks from {0} where name = "employee-23" and join_day=23 limit 5'.format(query_bucket)
            ...
            query_26 = 'explain select join_day from {0} where name = "employee-23" and join_yr = 2010 limit 5'.format(query_bucket)
