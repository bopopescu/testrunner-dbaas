...
class AutoReprovisionBaseTest(unittest.TestCase):
    ...
    def wait_for_failover_or_assert(main, autofailover_count, timeout, testcase):
        ...
        rest.print_UI_logs()
        testcase.log.warning("pools/default from {0} : {1}".format(main.ip, rest.cluster_status()))
...
class AutoReprovisionTests(unittest.TestCase):
    ...
    def verify_loaded_data(self, main, bucket, inserted_count):
        rest = RestConnection(main)
    ...
    def _cluster_setup(self):
        ...
        for bucket in buckets:
            ...
            inserted_count, rejected_count = self.load_bucket_and_return_the_keys(servers=[self.main],
                                                                                name=bucket.name,
                                                                                # ram_load_ratio=0.02,
